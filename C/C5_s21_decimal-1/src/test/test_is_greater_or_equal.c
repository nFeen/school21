...
START_TEST(fail1) {
  s21_decimal decimal1 = s21_from_4int_to_decimal(0, 0, 0, 0xFFFFFFFF);
...
START_TEST(ok1) {
  s21_decimal decimal1 = {{0, 0xFFFFFFFF, 0xFFFFFFFF, 0}};
  s21_decimal decimal2 = {{1, 0xFFFFFFFF, 0, 0}};
  int code = s21_is_greater_or_equal(decimal1, decimal2);
...
Suite *s21_is_greater_or_equal_cases(void) {
  Suite *suite = suite_create("s21_is_greater_or_equal_cases");
